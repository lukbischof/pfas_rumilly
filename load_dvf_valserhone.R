...
for (txt_path in txt_files) {
  ...
  valserhone_results[[key]] <- df_r
  
  saveRDS(df_r, file.path(out_dir, paste0("valserhone_", key, ".rds")))
  
  rm(df_r)
  gc()
}

keep <- c("project_dir", "valserhone_results")

# Example: valserhone_results[["ValeursFoncieres-2024"]]