...
for (txt_path in txt_files) {
  ...
  rumilly_results[[key]] <- df_r
  
  saveRDS(df_r, file.path(out_dir, paste0("rumilly_", key, ".rds")))
  
  rm(df_r)
  gc()
}

keep <- c("project_dir", "rumilly_results")

# Example: rumilly_results[["ValeursFoncieres-2024"]]